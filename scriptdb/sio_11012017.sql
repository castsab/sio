...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2017 a las 01:40:10
...
-- Base de datos: `sio`
--
CREATE DATABASE IF NOT EXISTS `sio` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `sio`;
...
('Reportico', 2, 'reportico', NULL, 'i:1;', 1479571498, 1479571498),
...
(1, 1024472653, 1, 1, '1101', '', '', '', '', '', 1, 1478649998, 1478649998, 'Diego Armando', 'Castellanos Sabogal', '', '', 2147483647, NULL, NULL, 0, 0);
...
CREATE TABLE IF NOT EXISTS `client_contact` (
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_client_contact_client` (`document`),
  KEY `fk_client_contact_user` (`id_user`)
...
CREATE TABLE IF NOT EXISTS `quote` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_quote_user` (`id_user`),
  KEY `fk_quote_client` (`document`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `quote` (`id`, `id_user`, `document`, `discount`, `status`, `created_at`, `updated_at`, `apply_discount`, `status_quote`, `vbma`) VALUES
(1, 1, 1024472653, NULL, 1, 1478650026, 1478650026, 2, 1, 500000),
(2, 1, 1024472653, NULL, 1, 1478656586, 1478656586, 2, 1, 500000);
...
CREATE TABLE IF NOT EXISTS `quote_service` (
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_quote_service_quote` (`id_quote`),
  KEY `fk_quote_service_user` (`id_user`),
  KEY `fk_quote_service_service` (`id_service`)
...
INSERT INTO `quote_service` (`id`, `id_quote`, `id_user`, `id_service`, `estimate_hours`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 8, 1, 1478650106, 1478650106),
(2, 2, 1, 1, 10, 1, 1478656670, 1478656670);
...
(1, 'root@example.com', 'OVC9jFcj8v3Sf333l3vYgH6TuRzC6w6n', '$2y$13$4idVTvuJdb2ZprRn0.lxTux6VfcSCshI3Bbs5SDAP2BHolTEs1HoC', NULL, 'root@example.com', 1, 1476568841, 1476568841, NULL, NULL),
(2, 'castsab@gmail.com', 'v06jjS1ijXW-rZfxWXLIargrnRRLakLH', '$2y$13$JzmsHDZapu3tczBEAYVrKefmPvqAKphJYwAk3iWoH7A4DtQYGa3uO', NULL, 'castsab@gmail.com', 1, 1476573128, 1476573128, NULL, NULL),
(3, 'castsabproyectos@gmail.com', '8qlFIkkBJ-GMrXl7zAszGXoR073LB1sv', '$2y$13$WIJRfb8OKzDJI/vqiXMdQerbut.dXAbTVhBabyLQBhiiD9NfiKwLK', NULL, 'castsabproyectos@gmail.com', 1, 1476574101, 1476574101, NULL, NULL);
